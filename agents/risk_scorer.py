    ...
    def _generate_top_reasons(self, components: Dict, analyses: Dict,
        ...
        if len(reasons) < 3:
            try:
                ...
                if e >= 75: reasons.append("Strength: Above-average environmental disclosure and performance metrics.")
                g = float(pillar_scores.get("governance_score", 50) or 50)
                if g >= 75: reasons.append("Strength: Robust board independence and ESG governance structures.")
