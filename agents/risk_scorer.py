...
class RiskScorer:
    ...
    def calculate_pillar_scores(self, all_analyses: Dict[str, Any]) -> Dict[str, Any]:
        ...
        social_score = 30 + (soc_positive * 7) - soc_penalty
        social_score = max(0, min(100, social_score))

        if soc_positive == 0 and soc_negative == 0:
        ...
        governance_score = 35 + (gov_positive * 7) - gov_penalty
        governance_score = max(0, min(100, governance_score))
        if gov_positive == 0 and gov_negative == 0:
